...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s techroadcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  techroadcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded techroadcoin transaction") + "\n" +
              "  techroadcoin-tx [options] -create [commands]   " + _("Create hex-encoded techroadcoin transaction") + "\n" +
              "\n";
