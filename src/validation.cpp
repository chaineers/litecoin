...
#if defined(NDEBUG)
# error "Techroadcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Techroadcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("techroadcoin-scriptch");
