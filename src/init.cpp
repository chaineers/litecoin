...
void Shutdown()
{
    ...
    RenameThread("techroadcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/techroadcoin-project/techroadcoin>";
    const std::string URL_WEBSITE = "<https://techroadcoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("techroadcoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if techroadcoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if techroadcoin is started while in a temporary directory.\n",
