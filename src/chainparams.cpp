...
{
    const char* pszTimestamp = "KR Times 04/Jul/2018 Start the world of TechroadCoin";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1530687663, 562, 0x1f0fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2897dfd9c62896b5173c6969f22d782d86008688840d57386a027835d98ee1a7"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x2897dfd9c62896b5173c6969f22d782d86008688840d57386a027835d98ee1a7")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block 59c9b9d3fec105bdc716d84caa7579503d5b05b73618d0bf2d5fa639f780a011 (height 1353397).
            1530687663, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 96; // 75% for testchains
        ...
        genesis = CreateGenesisBlock(1530687673, 378, 0x1f0fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaf27a748bf85c98c14283accc0a57edaca7223833f142f289f712187cbcee3c3"));
        assert(genesis.hashMerkleRoot == uint256S("0x8153858645254cff61b4e1a5e255258a5d395733df89fc511817db6568c22755"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0xaf27a748bf85c98c14283accc0a57edaca7223833f142f289f712187cbcee3c3")},
            }
        };
